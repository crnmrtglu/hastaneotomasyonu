...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 27, 238, 295);
		...
		lbladsoyad_1.setBounds(262, 11, 103, 14);
		lbladsoyad_1.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 13));
		w_appointment.add(lbladsoyad_1);
		
		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(260, 27, 150, 35);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					for(int i=0; i<clinic.getClinicDoctorList(item.getKey()).size() ; i++) {
						...
						doctorData[1]=clinic.getClinicDoctorList(item.getKey()).get(i).getPassword();
		...
		btn_selDoctor.setBounds(258, 136, 152, 40);
		w_appointment.add(btn_selDoctor);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(420, 27, 238, 295);
		...
		lblNewLabel_1_1.setBounds(420, 5, 76, 25);
		w_appointment.add(lblNewLabel_1_1);
		
		JLabel lbladsoyad_1_1 = new JLabel("      Doktor Seç");
		lbladsoyad_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 13));
		lbladsoyad_1_1.setBounds(245, 110, 107, 15);
		w_appointment.add(lbladsoyad_1_1);
		
		JLabel lbladsoyad_1_1_1 = new JLabel("      Randevu Al");
		lbladsoyad_1_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 13));
		lbladsoyad_1_1_1.setBounds(245, 211, 107, 15);
		w_appointment.add(lbladsoyad_1_1_1);
		
		JButton btn_addAppoint = new JButton("Tıkla");
		...
		btn_addAppoint.setBounds(258, 237, 152, 40);
	...
	public void updateAppointModel(int hasta_id) {
	    try {
	        ...
	        // Modeli tabloya set et
	        table_whour.setModel(doctorModel);
	    } catch (SQLException e) {
	        e.printStackTrace();
	    }
	}
